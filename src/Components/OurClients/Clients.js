              ...
              <Carousel.Item interval={2000}>
                <div className="slide">
                  ...
                  <p>
                    ...
                    <br />
                    <span id="client-name">- Alex, Company galdius</span>
                  </p>
                </div>
              </Carousel.Item>
              <Carousel.Item interval={2000}>
                <div className="slide">
                  ...
                  <p>
                    ...
                    <br />
                    <br />
                    <span id="client-name">- STAR, Company GALAXY</span>
                  </p>
                </div>
              </Carousel.Item>
              <Carousel.Item interval={2000}>
                <div className="slide">
                  ...
                  <p>
                    ...
                    <br />
                    <br />
                    <span id="client-name">- ceaser, Company ROME</span>
                  </p>
                </div>
              </Carousel.Item>
              <Carousel.Item interval={2000}>
                <div className="slide">
                  ...
                  <p>
                    ...
                    <br />
                    <br />
                    <span id="client-name">- Rex, Company ABC</span>
                  </p>
                </div>
              </Carousel.Item>
            </Carousel>
